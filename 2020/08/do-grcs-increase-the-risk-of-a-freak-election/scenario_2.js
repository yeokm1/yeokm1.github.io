scenario_2 = function () {
    ...
    function drawChart(altShare, altShareGRC, tableID, pieID, barChartTitle) {
        ...
        if (barChart == null) {
            barChart = new Chart(ctx1, {
                type: 'bar',
                data: {
                    labels: ["A-SMC1", "A-SMC2", "A-SMC3", "B-SMC4", "B-SMC5", "B-SMC6", "C-SMC7", "C-SMC8", "C-SMC9", "D-SMC10", "D-SMC11", "D-SMC12", "E-SMC13", "E-SMC14", "E-SMC15"],
                    datasets: [
                        {
                            label: "Alternative",
        ...
        var tableData = document.getElementById("scenario_2-table")

        // GRC A
        tableData.rows[1].cells[1].innerHTML = ((incShare[0] + incShare[1] + incShare[2]) / 3).toFixed(1) + "%"
        tableData.rows[1].cells[2].innerHTML = ((altShare[0] + altShare[1] + altShare[2]) / 3).toFixed(1) + "%"

        // GRC B
        tableData.rows[2].cells[1].innerHTML = ((incShare[3] + incShare[4] + incShare[5]) / 3).toFixed(1) + "%"
        tableData.rows[2].cells[2].innerHTML = ((altShare[3] + altShare[4] + altShare[5]) / 3).toFixed(1) + "%"

        // GRC C
        tableData.rows[3].cells[1].innerHTML = ((incShare[6] + incShare[7] + incShare[8]) / 3).toFixed(1) + "%"
        tableData.rows[3].cells[2].innerHTML = ((altShare[6] + altShare[7] + altShare[8]) / 3).toFixed(1) + "%"

        // GRC D
        tableData.rows[4].cells[1].innerHTML = ((incShare[9] + incShare[10] + incShare[11]) / 3).toFixed(1) + "%"
        tableData.rows[4].cells[2].innerHTML = ((altShare[9] + altShare[10] + altShare[11]) / 3).toFixed(1) + "%"

        // GRC E
        tableData.rows[5].cells[1].innerHTML = ((incShare[12] + incShare[13] + incShare[14]) / 3).toFixed(1) + "%"
        tableData.rows[5].cells[2].innerHTML = ((altShare[12] + altShare[13] + altShare[14]) / 3).toFixed(1) + "%"
        ...
        tableData.rows[6].cells[1].innerHTML = incumbentSeatSharePercent + "%"

        //Alternative seat share
        tableData.rows[6].cells[2].innerHTML = alternativeSeatSharePercent + "%"
        ...
        tableData.rows[7].cells[1].innerHTML = (incShareTotal / altShare.length).toFixed(1) + "%"

        //Alternative popular vote %
        tableData.rows[7].cells[2].innerHTML = (altShareTotal / altShare.length).toFixed(1) + "%"

        //Popular Vote Swing
        tableData.rows[7].cells[0].innerHTML = "Popular Vote (Swing " + voteShift.toFixed(1) + "%)"
    ...
    function updateChart() {
        ...
        altShareGRC = [altShareAfterCycle.slice(0,3), altShareAfterCycle.slice(3,6), altShareAfterCycle.slice(6,9), altShareAfterCycle.slice(9,12), altShareAfterCycle.slice(12,15)]

        drawChart(altShareAfterCycle, altShareGRC, "scenario_2-bar", "scenario_2-pie", "Vote breakdown of individual SMCs")
    ...
    document.addEventListener("DOMContentLoaded", function (event) {
        ...
        simulationButton = document.getElementById("scenario_2-simulation-button")

        simulationButton.addEventListener('click', simulationButtonPressed);

        document.getElementById("scenario_2-reset-button").addEventListener('click', resetButtonPressed);

        document.getElementById("scenario_2-randomise-button").addEventListener('click', randomiseButtonPressed);

        incrementSlider = document.getElementById("scenario_2-slider")
