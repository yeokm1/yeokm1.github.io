scenario_0 = function () {
    ...
    function drawChart(altShare, tableID, pieID, barChartTitle) {
        ...
        var tableData = document.getElementById("scenario_0-table")
    ...
    function updateChart() {
        ...
        for (i = 0; i < altShareOriginal.length; i++) {
            altShareValue = altShareOriginal[i] + voteShift
        ...
        drawChart(altShareAfterCycle, "scenario_0-bar", "scenario_0-pie", "Vote breakdown of individual SMCs")
